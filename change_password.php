...
if(isset($_POST['form1'])) {
	...
	try {
		...
		if(empty($_POST['old'])) {
			throw new Exception(" পূবর্র পাসওয়ার্ড দিন");
		}
		...
		$statement = $db->prepare("SELECT * FROM homepage_admin WHERE admin_id=1");
		$statement->execute();
		...
		$statement = $db->prepare("UPDATE homepage_admin SET a_password=? WHERE admin_id=1");
...
?>
<div class="container">
<h1 class="center">পাসওয়ার্ড পরিবর্নতন করূন</h1>
